  ...
  if (Astro2.request.method === "POST") {
    ...
    if (action === "create") {
      ...
      if (name && parentCategory && slug) {
        const { error } = await supabase.from("subcategories").insert([{ name, slug, parent_category: parentCategory }]);
        if (error) {
