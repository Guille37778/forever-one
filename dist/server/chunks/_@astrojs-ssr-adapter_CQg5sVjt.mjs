import { fileExtension, joinPaths, slash, prependForwardSlash, removeTrailingForwardSlash, appendForwardSlash, collapseDuplicateTrailingSlashes, hasFileExtension } from '@astrojs/internal-helpers/path';
import { r as requestIs404Or500, i as isRequestServerIsland, n as notFound, a as normalizeTheLocale, b as redirectToFallback, c as redirectToDefaultLocale, d as requestHasLocale, e as defineMiddleware, S as SERVER_ISLAND_COMPONENT, f as SERVER_ISLAND_ROUTE, g as createEndpoint, R as RouteCache, s as sequence, h as findRouteToRewrite, m as matchRoute, j as RenderContext, P as PERSIST_SYMBOL, k as getSetCookiesFromResponse } from './index_Dsbm_Fvf.mjs';
import { a1 as ROUTE_TYPE_HEADER, x as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, ah as ActionNotFoundError, a6 as clientAddressSymbol, ai as LocalsNotAnObject, aj as REROUTABLE_STATUS_CODES, aa as responseSentSymbol } from './astro/server_BtsvdxdT.mjs';
import 'cookie';
import { bold, red, yellow, dim, blue } from 'kleur/colors';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_DXh6OH-B.mjs';
import { D as DEFAULT_404_ROUTE, c as default404Instance, e as ensure404Route } from './astro-designed-error-pages_B38TyWiE.mjs';
