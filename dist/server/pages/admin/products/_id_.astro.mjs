...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.request.method === "POST") {
    ...
    if (action === "delete") {
      ...
      const { error: pError } = await supabaseAdmin.from("products").update({ name, description, price, collection_id: collectionId, category, subcategory_id: subcategoryId, is_active: isActive, image_urls: imageUrls, updated_at: /* @__PURE__ */ new Date() }).eq("id", id);
      if (pError) {
  ...
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": `Editar \u2014 ${product.name}`, "activeNav": "products", "user": { email: user?.email || "" }, "data-astro-cid-jwnaoqkz": true }, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<a href="/admin/products" class="back-link" data-astro-cid-jwnaoqkz>← Volver al Inventario</a> <div class="page-header" data-astro-cid-jwnaoqkz> <p data-astro-cid-jwnaoqkz>Inventario · Editar Pieza</p> <h2 data-astro-cid-jwnaoqkz>Detalles del Producto</h2> </div> ${successMessage && renderTemplate`<div class="message success" data-astro-cid-jwnaoqkz>${successMessage}</div>`}${errorMessage && renderTemplate`<div class="message error" data-astro-cid-jwnaoqkz>${errorMessage}</div>`}<form method="POST" class="form-card" enctype="multipart/form-data" data-astro-cid-jwnaoqkz> <div class="form-section" data-astro-cid-jwnaoqkz> <p class="section-label" data-astro-cid-jwnaoqkz>✦ Información General</p> <div class="form-grid-main" data-astro-cid-jwnaoqkz> <div class="form-group" data-astro-cid-jwnaoqkz><label data-astro-cid-jwnaoqkz>Nombre de la Prenda *</label><input type="text" name="name"${addAttribute(product.name, "value")} required data-astro-cid-jwnaoqkz></div> <div class="form-group" data-astro-cid-jwnaoqkz><label data-astro-cid-jwnaoqkz>Precio (USD) *</label><input type="number" name="price"${addAttribute(product.price, "value")} step="0.01" required data-astro-cid-jwnaoqkz></div> </div> <div class="form-grid-three" data-astro-cid-jwnaoqkz> <div class="form-group" data-astro-cid-jwnaoqkz> <label data-astro-cid-jwnaoqkz>Categoría Principal</label> <select name="category" id="category" data-astro-cid-jwnaoqkz> <option value="ropa"${addAttribute(product.category === "ropa", "selected")} data-astro-cid-jwnaoqkz>Ropa</option> <option value="accesorios"${addAttribute(product.category === "accesorios", "selected")} data-astro-cid-jwnaoqkz>Accesorios</option> </select> </div> <div class="form-group" data-astro-cid-jwnaoqkz> <label data-astro-cid-jwnaoqkz>Subcategoría</label> <select name="subcategory_id" id="subcategory_id" data-astro-cid-jwnaoqkz> <option value="" data-astro-cid-jwnaoqkz>Sin subcategoría</option> ${allSubcategories?.map((s) => renderTemplate`<option${addAttribute(s.id, "value")}${addAttribute(s.parent_category, "data-parent")}${addAttribute(product.subcategory_id === s.id, "selected")} data-astro-cid-jwnaoqkz>${s.name}</option>`)} </select> </div> <div class="form-group" data-astro-cid-jwnaoqkz> <label data-astro-cid-jwnaoqkz>Colección</label> <select name="collection_id" data-astro-cid-jwnaoqkz> <option value="" data-astro-cid-jwnaoqkz>Sin colección</option> ${collections?.map((c) => renderTemplate`<option${addAttribute(c.id, "value")}${addAttribute(product.collection_id === c.id, "selected")} data-astro-cid-jwnaoqkz>${c.name}</option>`)} </select> </div> </div> <div class="form-group" data-astro-cid-jwnaoqkz> <label data-astro-cid-jwnaoqkz>Estado Visibilidad</label> <select name="is_active" data-astro-cid-jwnaoqkz> <option value="true"${addAttribute(product.is_active, "selected")} data-astro-cid-jwnaoqkz>● Público en Tienda</option> <option value="false"${addAttribute(!product.is_active, "selected")} data-astro-cid-jwnaoqkz>○ Oculto del Catálogo</option> </select> </div> <div class="form-group" data-astro-cid-jwnaoqkz><label data-astro-cid-jwnaoqkz>Descripción de Lujo</label><textarea name="description" data-astro-cid-jwnaoqkz>${product.description}</textarea></div> <div class="form-group" data-astro-cid-jwnaoqkz> <label data-astro-cid-jwnaoqkz>Medios Actuales</label> <div class="current-images" data-astro-cid-jwnaoqkz> ${product.image_urls?.map((url, index) => renderTemplate`<div class="image-thumb" data-astro-cid-jwnaoqkz> <img${addAttribute(url, "src")}${addAttribute(`Imagen ${index}`, "alt")} data-astro-cid-jwnaoqkz> <input type="hidden" name="existing_image_urls[]"${addAttribute(url, "value")} data-astro-cid-jwnaoqkz> <button type="button" class="remove-img-btn" onclick="this.parentElement.remove()" data-astro-cid-jwnaoqkz>×</button> </div>`)} </div> <div class="new-upload" data-astro-cid-jwnaoqkz><label style="font-size: 7px; color: #B8860B; margin-bottom: 0.5rem; display:block" data-astro-cid-jwnaoqkz>Añadir Nuevas Fotos</label><input type="file" name="new_image_files" accept="image/*" multiple data-astro-cid-jwnaoqkz></div> </div> </div> <!-- Stock --> <div class="form-section" id="sizeSelection" data-astro-cid-jwnaoqkz> <p class="section-label" data-astro-cid-jwnaoqkz>◈ Stock por Talla</p> <div class="sizes-grid" data-astro-cid-jwnaoqkz> ${["XS", "S", "M", "L", "XL", "XXL", "UNICO"].map((size) => {
    const variant = product.variants.find((v) => v.size === size);
    return renderTemplate`<div class="size-item" data-astro-cid-jwnaoqkz> <input type="checkbox" name="sizes[]"${addAttribute(size, "value")}${addAttribute(`size-${size}`, "id")}${addAttribute(!!variant, "checked")} data-astro-cid-jwnaoqkz> <label class="size-label"${addAttribute(`size-${size}`, "for")} data-astro-cid-jwnaoqkz>${size}</label> </div>`;
  ...
  })} </div> </div> <div class="form-footer" data-astro-cid-jwnaoqkz> <a href="/admin/products" class="cancel-link" data-astro-cid-jwnaoqkz>Cancelar</a> <div class="footer-actions" data-astro-cid-jwnaoqkz> <button type="submit" name="action" value="delete" class="delete-btn" onclick="return confirm('¿Seguro que deseas eliminar esta pieza permanentemente?')" data-astro-cid-jwnaoqkz>Eliminar Prenda</button> <button type="submit" class="submit-btn" data-astro-cid-jwnaoqkz>✦ Guardar Cambios</button> </div> </div> </form> ` })} ${renderScript($$result, "C:/Users/Usuario/Desktop/proyectos reales/forever-one/src/pages/admin/products/[id].astro?astro&type=script&index=0&lang.ts")}`;
