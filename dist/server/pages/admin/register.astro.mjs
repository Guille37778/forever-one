import { e as createComponent, l as renderHead, g as addAttribute, r as renderTemplate, h as createAstro } from '../../chunks/astro/server_BtsvdxdT.mjs';
import 'kleur/colors';
import 'clsx';
  ...
  if (Astro2.request.method === "POST") {
    ...
    if (email && password) {
      ...
      if (error) {
        ...
        message = "Registro iniciado. Por favor, confirma tu email (revisa tu spam o act\xEDvalo manualmente en el panel de Supabase).";
        messageType = "success";
      } else {
